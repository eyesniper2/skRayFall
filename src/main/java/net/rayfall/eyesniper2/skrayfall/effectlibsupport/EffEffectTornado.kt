...
class EffEffectTornado : Effect() {
    ...
    // %string% [with tornado particle[s] %particles% and cloud particle[s]
    ...
    private var tornadoParticleExpression: Expression<ParticleEffect>? = null
    private var cloudParticleExpression: Expression<ParticleEffect>? = null
    ...
    override fun init(exp: Array<Expression<*>?>, arg1: Int, arg2: Kleenean, arg3: SkriptParser.ParseResult): Boolean {
        ...
        tornadoParticleExpression = exp[2] as? Expression<ParticleEffect>?
        cloudParticleExpression = exp[3] as? Expression<ParticleEffect>?
