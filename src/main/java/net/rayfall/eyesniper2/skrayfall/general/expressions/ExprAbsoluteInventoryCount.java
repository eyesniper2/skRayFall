...
@Description("Get the number of items in a player’s inventory that are an absolute match " +
        "to a sample item. To match they must have the same enchants, name and lore.")
