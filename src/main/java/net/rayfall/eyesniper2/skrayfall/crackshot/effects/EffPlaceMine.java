...
@Name("Place CrackShot Mine")
@Description("Set a CrackShot mine at a location for a player. The string is the weapons name " +
        "that will be responsible for the damage.")
