package net.rayfall.eyesniper2.skrayfall.v1_16_2;
...
public class EffTitleV1_16_2 extends Effect {
        ...
        for (Player p : player.getAll(evt)) {
            ...
            if (subTitle != null) {
                IChatBaseComponent finalSub =
                        IChatBaseComponent.ChatSerializer.a("{\"text\": \"" + subTitle.getSingle(evt) + "\"}");
            ...
            if (title != null) {
                IChatBaseComponent finalTitle =
                        IChatBaseComponent.ChatSerializer.a("{\"text\": \"" + title.getSingle(evt) + "\"}");
